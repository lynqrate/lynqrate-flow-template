alter table "public"."pass_rollup_digests" drop constraint "pass_rollup_digests_last_entry_no_check";

alter table "public"."pass_rollup_digests" drop column "last_entry_no";
