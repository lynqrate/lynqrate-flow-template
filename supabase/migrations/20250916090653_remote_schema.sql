create sequence "public"."rpc_debug_log_id_seq";


  create table "public"."rpc_debug_log" (
    "id" bigint not null default nextval('rpc_debug_log_id_seq'::regclass),
...
CREATE UNIQUE INDEX rpc_debug_log_pkey ON public.rpc_debug_log USING btree (id);

alter table "public"."rpc_debug_log" add constraint "rpc_debug_log_pkey" PRIMARY KEY using index "rpc_debug_log_pkey";
